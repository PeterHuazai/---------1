...
大学生学习管理平台——集课程表、任务管理、学习打卡、校园生活（活动、二手、失物招领、资讯）于一体的一站式校园服务平台。

## 管理员账号

> **管理员拥有完整的后台管理权限**，登录后顶部导航显示「管理后台」入口。

| 角色     | 邮箱                  | 密码          |
|----------|-----------------------|---------------|
| 管理员   | `admin@miaoda.com`    | `Admin@1234`  |

登录路径：点击右上角「登录」→ 切换至「管理员登录」标签 → 输入以上账号密码。
