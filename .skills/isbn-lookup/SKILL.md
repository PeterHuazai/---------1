...
- **Endpoint**：`POST https://app-bvo9cuao8lq9-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query`
...
async function queryIsbnInfo(isbn: string): Promise<IsbnDetail[]> {
  const url = new URL("https://app-bvo9cuao8lq9-api-ra5EZDjVKbza-gateway.appmiaoda.com/isbn/query");
